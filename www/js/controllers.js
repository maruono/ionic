...
var Add_radio, Add_title, Area_auto_size, Click_coffee, Cpm, Cpm_tom, Delete_button, Disp, Edit_memo, Select_memo_disp, Select_strage, TestCtrl, Title_and_memo;
...
Add_radio = (function() {
  ...
  Add_radio.prototype.story1 = function() {
    ...
    for (i = j = 1, ref = num; 1 <= ref ? j <= ref : j >= ref; i = 1 <= ref ? ++j : --j) {
      ...
      results.push(this.add(i, story1_2.title));
    }
    return results;
  };
...
Select_memo_disp = (function() {
  ...
  Select_memo_disp.prototype.title_memo_disp = function() {
    ...
    this.disp.disp(this.value3.title);
    this.converter = new showdown.Converter();
    this.mark2html = this.converter.makeHtml(this.value3.memo);
    return this.disp.add(this.mark2html);
  };
